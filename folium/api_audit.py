...
according to the rules declared in :mod:`folium.api_policy`.
...
are defined in :mod:`folium.api_policy`.
...
Usage:
    python -m folium.api_audit              # run all checks, exit non-zero on error
    python -m folium.api_audit --json        # machine-readable output
    python -m folium.api_audit --strict      # treat warnings as errors
"""
